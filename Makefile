...
LDFLAGS+=-L. -g
#^|
EXAMPLESOBJS=  account.o datageneration.o display.o filter.o refresh.o register.o write.o queue.o main.o generat.o cpu.o transduc.o distri.o com.o linpack.o debug.o trafico.o
#@
...
#^|
account.o: /cygdrive/C/eclipse/workspace/test/account.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
datageneration.o: /cygdrive/C/eclipse/workspace/test/datageneration.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
display.o: /cygdrive/C/eclipse/workspace/test/display.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
filter.o: /cygdrive/C/eclipse/workspace/test/filter.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
refresh.o: /cygdrive/C/eclipse/workspace/test/refresh.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
write.o: /cygdrive/C/eclipse/workspace/test/write.cpp
	${CPP} -c ${LDFLAGS} ${INCLUDES_CPP} ${DEFINES_CPP} ${DEBUGFLAGS} ${CPPFLAGS} $< 
#
...
#^|
account.o: /cygdrive/C/eclipse/workspace/test/account.cpp \
 /cygdrive/C/eclipse/workspace/test/account.h \
 ...
 /cygdrive/C/eclipse/workspace/test/message.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/strutil.h \
 /cygdrive/C/eclipse/workspace/test/mainsimu.h \
...
datageneration.o: \
 /cygdrive/C/eclipse/workspace/test/datageneration.cpp \
 /cygdrive/C/eclipse/workspace/test/datageneration.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
display.o: /cygdrive/C/eclipse/workspace/test/display.cpp \
 /cygdrive/C/eclipse/workspace/test/display.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
filter.o: /cygdrive/C/eclipse/workspace/test/filter.cpp \
 /cygdrive/C/eclipse/workspace/test/filter.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
 ...
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/ltranadm.h
refresh.o: /cygdrive/C/eclipse/workspace/test/refresh.cpp \
 /cygdrive/C/eclipse/workspace/test/refresh.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/model.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/port.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/modelid.h \
...
register.o: /cygdrive/C/eclipse/workspace/test/register.cpp \
 ...
 /cygdrive/C/eclipse/workspace/test/filter.h \
 /cygdrive/C/eclipse/plugins/CD++Builder_1.1.0/internal/atomic.h \
 /cygdrive/C/eclipse/workspace/test/write.h \
 /cygdrive/C/eclipse/workspace/test/display.h \
 /cygdrive/C/eclipse/workspace/test/account.h \
 /cygdrive/C/eclipse/workspace/test/refresh.h \
 /cygdrive/C/eclipse/workspace/test/datageneration.h
